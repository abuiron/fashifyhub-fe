  ...
  return (
    <Stack sx={{backgroundColor:theme.palette.primary.main,paddingTop:"3rem",paddingLeft:is700?"1rem":"3rem",paddingRight:is700?"1rem":"3rem",paddingBottom:"1.5rem",rowGap:"5rem",color:theme.palette.primary.light,justifyContent:"space-around"}}>
            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700?"":'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography variant='h6'>For Services</Typography>
                    <Typography sx={labelStyles}>abuthakir-s-portfolio.netlify.app</Typography>
                    <Typography sx={labelStyles}>abuiron80@gmail.com</Typography>
                    <Typography sx={labelStyles}>mariganeshmr@gmail.com</Typography>
                </Stack>
            ...
            <Stack alignSelf={"center"}>
                <Typography color={'GrayText'}>&copy; MAT Industries {new Date().getFullYear()}. All right reserved</Typography>
            </Stack>
